 ...
 * </blockquote>
 *
 * This example demonstrates what happens if mutable objects are used in a
 * tree set.
 */
public class SetDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Whhhaaaaaat? Now there are duplicates and this isn't even behaving like
		 * a normal set! This is caused by the mutation/change made to one of the
